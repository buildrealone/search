...
useEffect(() => {
  ...
  <div>
      ...
      {data?.all_datalab?.map((num) => { return num?.period } )?.length && data?.mobile_datalab?.map((num) => { return num?.period } )?.length && data?.all_datalab?.map((num) => { return num?.period } )?.length === data?.mobile_datalab?.map((num) => { return num?.period } )?.length 
